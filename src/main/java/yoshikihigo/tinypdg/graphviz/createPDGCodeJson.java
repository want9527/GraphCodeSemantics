...
public class createPDGCodeJson {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0; i<S.list.size(); i++){
            ...
            StringBuilder javaCodePath = new StringBuilder(pdgDotFile + File.separator);
            ...
            pdgPath = javaCodePath + File.separator + pathParts[pathParts.length - 1] + ".pdg.dot";
            cmd[1] = codePath;
            cmd[3] = pdgPath;
